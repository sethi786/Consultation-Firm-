  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "The content, design, and code of this site are owned by Cairn Security or its licensors and are provided for your information. Framework references (NIST CSF, ISO/IEC 27001, CIS Controls) belong to their respective bodies and are used for identification only.",
        ],
      },
      {
...
function SecurityPosture() {
  ...
  return (
    <Table caption="Cairn Security posture">
      <THead>
        <TR>
          <TH>Area</TH>
          <TH>Posture</TH>
