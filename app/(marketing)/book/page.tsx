...
export const metadata: Metadata = {
  ...
  description:
    "Pick a time and book a meeting with a Waypoint consultant. Choose what it's about, and we'll confirm the slot and send a calendar invite — no back-and-forth.",
