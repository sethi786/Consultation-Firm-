...
export const metadata: Metadata = {
  title: "About",
  description:
    "Waypoint Security is an evidence-led security consultancy and managed security services provider for 200–5,000-seat organisations.",
    ...
    <>
      <Container className="pt-14 pb-8 md:pt-20">
        ...
        <p className="mt-4 max-w-measure text-lede text-slate">
          Waypoint Security is a consultancy and managed security services provider
