 ...
 * lands here (status "requested"). Northport confirms and adds the meeting link.
...
export const CallBookings: CollectionConfig = {
  ...
  fields: [
    ...
    { name: "meetingLink", type: "text", admin: { description: "Added by Northport on confirmation." } },
  ],
  timestamps: true,
};
